## sick_safevisionary_ros2 (rolling) - 1.0.5-1

The packages in the `sick_safevisionary_ros2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling sick_safevisionary_ros2` on `Thu, 07 May 2026 09:08:16 -0000`
...
## sick_safevisionary_ros2 (kilted) - 1.0.5-1

The packages in the `sick_safevisionary_ros2` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted sick_safevisionary_ros2` on `Thu, 07 May 2026 09:06:27 -0000`
